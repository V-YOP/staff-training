...
// export function intervalsBetween(startIntervalInclusive: string, endIntervalInclusive: string): string[] {
...
//   return Object.values(SEMITONE2INTERVALS).flatMap(R.identity)
// }